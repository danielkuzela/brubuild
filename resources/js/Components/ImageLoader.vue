    ...
    <div>
        ...
        >
            <div
                ...
                class="fixed w-full h-full inset-0 bg-black/80 flex justify-center items-center z-50"
            ...
            >
                ...
                <div class="absolute right-5 top-5 z-20 cursor-pointer group" @click="zoomable ? zoomed = false : ''">
